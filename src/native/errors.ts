export type FailureCode = 'invalid_request' | 'configuration_required' | 'authentication_failed' | 'request_failed' | 'source_blocked' | 'invalid_response' | 'response_incomplete' | 'ambiguous_match' | 'unsupported_runtime';
